...
Project untuk menyelesaikan take home test, dibangun dengan Spring Boot.
...
1. Convert to Readable
    ...
    - **Example:** [http://localhost:8080/readable?s=iadab%20itsap%20ulalreb](http://localhost:8080/readable?s=iadab%20itsap%20ulalreb)

2. FizzBuzz
    - **Endpoint:** `/fizzbuzz`
    - **Method:** `GET`
    - **Response:** Serangkaian angka dari 1 hingga 100 dengan penerapan aturan FizzBuzz
    - **Example:** [http://localhost:8080/fizzbuzz](http://localhost:8080/fizzbuzz)
...
3. Fibonacci
    ...
    - **Example:** [http://localhost:8080/fibonacci?n=9](http://localhost:8080/fibonacci?n=9)
...
4. Max Profit
    ...
    - **Example:** [http://localhost:8080/maxProfit?prices=10,9,6,5,15](http://localhost:8080/maxProfit?prices=10,9,6,5,15)
...
5. Count Numbers
    ...
    - **Example:** [http://localhost:8080/countNumbers?str=2,h,6,u,y,t,7,j,y,h,8](http://localhost:8080/countNumbers?str=2,h,6,u,y,t,7,j,y,h,8)
...
- **Example:** [http://localhost:8080/summary](http://localhost:8080/summary)
